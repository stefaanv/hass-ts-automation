export default {
  ...
  blockFilter: '^sensor.energy|^sensor.gw2000a|^sensor.voltage|^sensor.power|^sensor.current|^media_player',
  //'|^sensor.current|^media_player|^sensor.inverter_pv|^sensor.slimmelezer',
}
